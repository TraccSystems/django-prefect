...
class PostgressConnectionForm(ModelForm):
    class Meta:
        ...
        fields = ("connection_name","database_name","host","password","port","username","source_name")

class PineconeConnectionForm(ModelForm):
    class Meta:
        model = Pinecone_connection
        fields = ("connection_name","api_key","environment","index_name","target_name")
...
class SingleStoreDBConnectionsForm(ModelForm):
    class Meta:
        ...
        fields = ("connection_name","target","singledb_url","table_name")
