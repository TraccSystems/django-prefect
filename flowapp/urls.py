...
urlpatterns = [
    ...
    path('deployment/delete/<uuid:deployment_id>/',delete_deployment,name="delete-deployment"),
    path('flow/delete/<uuid:flow_id>/',delete_flow,name="delete-flow"),
    path("run/deployment/<uuid:deployment_id>/",run_flow_from_deployment,name="run-deployment"),
    path('flow/runs/',read_all_flows_runs,name="flow-runs"),
